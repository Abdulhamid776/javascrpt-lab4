...
async function populate() {
    ...
    const url = "https://Abdulhamid776.github.io/javascrpt-lab4/js/i-scream.json";
...
// Existing ice cream flavors inventory
let iceCreamInventory = [
    { flavor: 'Chocolate', quantity: 20 },
    { flavor: 'Vanilla', quantity: 15 },
    { flavor: 'Strawberry', quantity: 18 }
];

// Function to add new ice cream flavors to inventory
function addNewFlavors(flavors) {
    flavors.forEach(flavor => {
        iceCreamInventory.push({ flavor: flavor, quantity: 0 }); // Assuming initial quantity is 0
    });
}

// Adding two new flavors
addNewFlavors(['Mint Chocolate Chip', 'Cookies and Cream']);
